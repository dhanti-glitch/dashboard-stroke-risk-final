...
<img width="116" height="126" alt="image" src="https://github.com/user-attachments/assets/1885cd88-d47f-4866-aa7c-8bec0aa90885" /> 
...
3. Jalankan semua cell dari atas ke bawah <br>

***Opsi 2 — Lokal***
1. Clone repository<br>
2. Install dependencies: pip install -r requirements.txt<br>
3. Jalankan notebook: jupyter notebook notebooks/DS_StrokePrediction.ipynb<br>
4. Jalankan dashboard: streamlit run dashboard/app.py<br>
